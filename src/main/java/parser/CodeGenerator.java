...
public class CodeGenerator {
    ...
    private void doStuff() {
        ...
        var scaff = classLoader.getResourceAsStream("Code.java");
        try {
            assert scaff != null;
            var lines = new BufferedReader(new InputStreamReader(scaff, StandardCharsets.UTF_8)).lines().collect(Collectors.toList());
